...
- [app/llama-index-azure-dynamic-session.bicep](./infra/app/llama-index-azure-dynamic-session.bicep) - Azure Container Apps resources to host the 'llama-index-azure-dynamic-session' service.
